...
ROOT_URLCONF = 'SpaceShooter.urls'
...
WSGI_APPLICATION = 'SpaceShooter.wsgi.application'
...
STATIC_ROOT = PROJECT_DIR.child('SpaceShooter','static_root')
...
MEDIA_URL = '/media/'
MEDIA_ROOT = PROJECT_DIR.child('SpaceShooter','media_root')
